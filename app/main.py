...
from app.routers import auth, health, me, messages, rooms, users, ws
...
def create_app(settings: Settings | None = None, redis_factory: Callable[[], Redis] | None = None) -> FastAPI:
    ...
    routers = (health.router, auth.router, me.router, users.router, rooms.router, messages.router, ws.router)
